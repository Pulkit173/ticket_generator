...
function TicketGenerator() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4">
      {/* Navigation Steps */}
      <div className="flex space-x-20 mb-6 text-sm text-gray-400">
        ...
        <div className="w-full max-w-2xl bg-black p-6 rounded-lg shadow-lg">
          ...
          <div className="flex justify-center mt-6">
            <button
              ...
              className="w-full md:w-60 bg-[#054234] py-2 rounded-md hover:bg-green-700"
            >
              Generate Ticket
            </button>
          </div>
      ...
      {step === 2 && (
        <div className="w-full max-w-[350px] mx-auto my-6">
          <div className="relative h-[455px] bg-white rounded-xl text-gray-800 text-xs uppercase">
            {/* Header */}
            <header className="bg-gradient-to-b from-gray-800 to-gray-700 p-3 flex justify-between items-center text-white">
              <img
                src="https://s3-alpha-sig.figma.com/img/c64c/8948/b0d57ef03e84484835d5a2bc1f5a2116?Expires=1739145600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=lWRgc4wdnJgj2psXf2k2g9m2aM-0O3EyIn17WoCeD~vWuTZ8F5uAJUdUmxalFV4Kj1OAyQfsVE4FefB~Bxub6O1cJH5vdKiKygjBOBmvxWYW2JMvRO3-d9GQ-zX4tNnbVUZgtFNgtpo3i1SMlc9gQZO4XLIgtiqPyqCLC8byDis6hPwJt-teWKHhcXqKiEt-Q2P~ctV44Qt5XYNDSk4fucuSvlL0vnu6lkPHqwLdr8HbnVR-rsLaJxU2MqKrnsyzqU~aO2b3uE3tjaXWMvxH8NRj8d8Yt4ZP0pGzLIEbiZZvvqs31X5jrOoL510c5bJCjMNJXN7~pZC0iRYw9QWFSQ__"
                alt="Logo"
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="w-full md:w-80 bg-[#054234] py-3 rounded-md hover:bg-green-700 text-lg"
            >
              Download Ticket
            </button>
          </div>
      ...
      {step === 3 && (
        <div className="w-full max-w-2xl p-6 rounded-lg shadow-lg text-center text-white">
          ...
          <div className="flex justify-center items-center h-34">
            <div className="text-[#054234] text-6xl">
              <FaCheckCircle />
            </div>
          </div>
